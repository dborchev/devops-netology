...
14. Узнайте что делает команда `tee` и почему в отличие от `sudo echo` команда с `sudo tee` будет работать.
    1. `tee` направляет вывод одновременно в указанный в параметрах файл и в `stdout`, что очень полезно для логгирования работы скриптов
    2. в условиях этого задания, она работает с правами `sudo`, а значит может писать в указанный файл, в отличии от перенаправления вывода, которое выполняется башем с правами баша (текущего пользователя)
